...
results = runExperimentArcade('directoryName', 'StimuliCondition2_covScaleFactor_1_00_NoReflection',...
...
display([num2str(results(1)), ' correct out of ', num2str(results(2))]);
