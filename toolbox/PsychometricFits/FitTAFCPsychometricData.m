function [threshold,fitFractionCorrect,paramsValues] = FitTAFCPsychometricData(criterionFraction,stimLevels,fractionCorrect,numTrials,fitStimLevels)
%FitTAFCPsychometricData
%   [threshold,fitFractionCorrect,paramsValues] = FitTAFCPsychometricData(criterionFraction,stimLevels,fractionCorrect,numTrials,fitStimLevels)
% 
...
% fitted curve. 
%
% Note that this function requires and makes use of Palamedes Toolbox 1.8,x
%
% Inputs:
%   criterionFraction - Fraction correct at which to find a threshold.
%   stimLevels - An N-vector representing stimuli levels corresponding to the data.
...
%   fitStimLevels - Vector, stimulus levels to return fit function on
% Outputs:
%   threshold - The estimated threshold
%   fitFractionCorrect - Fit psychometric function on fitStimLevels.
%   paramsValues - Palemedes parameters for the fit.
%
% xd  6/21/16 wrote it
