function summaryDataStruct = AnalyzeParametricConditions2(subjectToAnalyze,conditionToAnalyze,analysisFitType)
% summaryStruct = AnalyzeParametricConditions2(subjectToAnalyze,conditionToAnalyze)
%
