function params = LightnessV4StaircasePIDriver(exp)
% LightnessV4StaircasePIDriver - Driver for the LightnessV4 experiments.
%
...
for t = 1:params.numPracticeTrials
    ...
    win.enableAllObjects({'startText','pim1','pim2'});
    win.draw;
